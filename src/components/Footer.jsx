  ...
  return (
    <>
      <div
        ...
        data-scroll-section
        data-scroll-speed="-.3"
        className=" bg-[#212121] h-screen w-full px-[4vw] pt-[8vw] pb-[6vw] flex"
      >
        <div className=" w-1/2 flex flex-col justify-between">
          <div>
            <h1 className="uppercase font-['Test_Founders_Grotesk_X-Condensed'] text-[9vw] leading-3">
              Eye-
            </h1>
            <h1 className="uppercase font-['Test_Founders_Grotesk_X-Condensed'] text-[9vw]">
              Opening
            </h1>
          </div>
          <svg
        ...
        <div>
          ...
          <div className="font-['Neue_Montreal_light'] flex justify-between">
            <div className="flex flex-col gap-8 mt-24">
              <div className="">
                ...
                <div className=" flex flex-col gap-1 mt-5">
                  <a
                    href=""
                    className="leading-5  tracking-wide border-b-[0.5px] w-fit"
                  >
                    Instagram
                  </a>
                  <a
              ...
              <h1 className="text-[#7a7a7a]">
                ...
                <a href="#" className="border-[#7a7a7a] border-b-[0.5px]">
                  Legal Terms
                </a>
              </h1>
            </div>
            <div className="mt-24 flex flex-col justify-between">
              ...
              <h1 className="leading-5 border-b-[0.5px] text-[#7a7a7a] border-[#7a7a7a]">
                Website by Obys
              </h1>
            </div>
          </div>
