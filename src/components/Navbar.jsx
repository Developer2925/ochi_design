...
const Navbar = () => {
  return (
    <>
      <div className="fixed z-[999] backdrop-blur w-full px-[4vw] py-[1vw] font-['Neue_Montreal_light'] flex items-center justify-between">
        <div className="logo">
          <svg
            width="72"
            height="30"
          ...
          {["Services", "Our work", "About us", "Insights", "Contact us"].map(
            (item, index) => (
              <a
                key={index}
                href=""
                className={`text-sm text-[#a3a2a2] tracking-wider hover:text-zinc-600 duration-300 ${
                  index === 4 && " ml-48"
                }`}
              >
                {item}
